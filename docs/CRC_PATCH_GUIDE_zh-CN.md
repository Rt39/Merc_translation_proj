...
走完本指南后，修改过的 asset bundle 不再被拒绝。继续看 [`STORY_BUNDLE_GUIDE_zh-CN.md`](STORY_BUNDLE_GUIDE_zh-CN.md) 或 [`FONT_REPLACEMENT_GUIDE_zh-CN.md`](FONT_REPLACEMENT_GUIDE_zh-CN.md)。
